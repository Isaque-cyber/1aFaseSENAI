...
function numerosParesMultiplos() {
    for (let i = 1; i <= 100; i++) {
        if (i % 2 === 0 && i % 3 === 0) {
            console.log(i);
        }
...
function numerosImparesMultiplos() {
    for (let i = 1; i <= 50; i++) {
        if (i % 2 !== 0 || i % 7 === 0) {
            console.log(i);
        }
...
function numerosParesDivisiveis() {
    for (let i = 1; i <= 20; i++) {
        if (i % 2 === 0 || i % 5 === 0) {
            console.log(i);
        }
...
function numerosMenores10Maior40() {
    for (let i = 1; i <= 50; i++) {
        if (i < 10 || i > 40) {
            console.log(i);
        }
